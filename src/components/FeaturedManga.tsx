  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-border bg-card">
      <div className="absolute inset-0">
        <img src={manga.cover} alt="" className="h-full w-full object-cover opacity-20 blur-2xl scale-110" />
      ...
      <div className="relative flex flex-col md:flex-row gap-6 p-6 md:p-10">
        ...
        <div className="flex flex-col justify-center space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">by {manga.author} · {manga.year}</p>
          </div>
